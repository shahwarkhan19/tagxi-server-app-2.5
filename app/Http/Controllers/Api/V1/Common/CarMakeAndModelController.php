...
class CarMakeAndModelController extends BaseController
{
    ...
    */
    ...
    public function testApi(Request $request){
        ...
        // DummyTableForTesting::create(['route_coordinates'=>$poly_line_string]);
        
        // dd($poly_line_string);

        $routes = Driver::intersects('route_coordinates',$poly_line_string)->where('id',2075)->get();
